      ...
      <div className="mt-12 space-y-10 text-sm leading-relaxed text-text-secondary">
        <section>
          ...
          <div className="mt-4 space-y-3">
            ...
            <p>
              ...
              Call, we store the phone number called, your custom prompt (if provided),
              the AI preset selected, call duration, and the full conversation transcript
              and summary generated by the AI agent. Call audio is processed in real-time
              by our AI provider and is not stored by VeraDial.
            </p>
            <p>
        ...
        <section>
          ...
          <div className="mt-4 space-y-3">
            ...
            <p>
              <strong className="text-text-primary">ElevenLabs:</strong> AI voice agent
              for AI Call features. When you use AI Call, call audio and your custom
              instructions are processed by ElevenLabs to generate the AI
              agent&apos;s responses. ElevenLabs receives the recipient&apos;s phone
              number and call audio during the call.{" "}
              <a
        ...
        <section>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              Custom prompts are stored with each AI call record.
            </li>
            <li>
