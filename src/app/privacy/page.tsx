        ...
        <section>
          ...
          <div className="mt-4 space-y-3">
            ...
            <p>
              ...
              enable call recording, dual-channel audio is recorded by Twilio and stored on
              their servers. We store a reference to the recording and provide playback
              through our app.
            </p>
            <p>
            ...
            <p>
              ...
              call duration, the AI provider used, and the full conversation transcript and
              summary generated by the AI agent. Call audio is processed in real-time by the
              selected AI provider (ElevenLabs, OpenAI, or Google) and is not stored by
              VeraDial.
            </p>
            <p>
