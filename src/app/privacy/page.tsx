        ...
        <section>
          ...
          <div className="mt-4 space-y-3">
            ...
            <p>
              ...
              third-party AI provider (ElevenLabs or Cartesia, depending on the
              voice type). For recorded greetings, your uploaded audio is
              converted to MP3 format on our server. All greeting audio is
              stored in cloud storage (Supabase Storage).
            </p>
            <p>
              <strong className="text-text-primary">Voice cloning:</strong> If
              you create a cloned voice, we collect the voice sample you record,
              your consent acknowledgment, and metadata about the resulting
              voice model. The raw voice sample is processed server-side and
              sent to Cartesia to create the clone; VeraDial does not retain the
              raw sample after successful clone creation. We store the Cartesia
              voice identifier, clone name, consent record, and generated
              greeting audio made with that clone until you delete the clone,
              the greeting, or your account.
            </p>
            <p>
            ...
            <p>
              ...
              you explicitly turn on Contact Memory in Profile &gt; Contact
              Memory, we generate a rolling AI summary for each phone number you
              interact with, using your call transcripts, voicemail
        ...
        <section>
          ...
          <div className="mt-4 space-y-3">
            <p>
              ...
              the data required for its specific function. We require service
              providers that process personal data for VeraDial to protect that
              data under privacy and security obligations that provide the same
              or equal protection required by this Privacy Policy.
            </p>
            <p>
            ...
            <p>
              ...
              voice processing for AI Call, ElevenLabs-backed Call Screening,
              and Voicemail Greetings. For AI calls and ElevenLabs screening,
              call audio and your instructions or screening prompts are
              processed to generate the AI agent&apos;s responses. For voicemail
              greetings, your greeting text is converted to speech audio.{" "}
              <a
            ...
            <p>
              <strong className="text-text-primary">Cartesia:</strong> Voice
              cloning and cloned voice text-to-speech for voicemail greetings.
              When you create a cloned voice, your recorded sample is sent to
              Cartesia to create the voice model. When you generate a greeting
              with that clone, your greeting text and selected voice identifier
              are sent to Cartesia to generate audio.{" "}
              <a
            ...
            <p>
              ...
              processing for AI Call and, when selected through LiveKit
              screening, Call Screening. When OpenAI is selected as the AI
              provider, call audio and your instructions or screening prompts
              are processed in real-time by OpenAI&apos;s Realtime API to
              generate the AI agent&apos;s responses.{" "}
              <a
            ...
            <p>
              ...
              processing for AI Call, LiveKit-routed Call Screening when Gemini
              is selected, and Contact Memory. For AI calls and screening, call
              audio and your instructions or screening prompts are processed in
              real-time by Google&apos;s Gemini API to generate the AI
              agent&apos;s responses. For Contact Memory, text from your call
            ...
            <p>
              ...
              voice processing for AI Call and, when selected through LiveKit
              screening, Call Screening. When xAI is selected as the AI
              provider, call audio and your instructions or screening prompts
              are processed by xAI&apos;s Grok API to generate the AI
              agent&apos;s responses.{" "}
              <a
            ...
            <p>
              ...
              audio routing and SIP connectivity for AI calls and LiveKit-backed
              call screening. When LiveKit transport is used, call audio is
              routed through LiveKit&apos;s infrastructure to connect the AI
              agent with the phone call. LiveKit processes call audio in transit
