    ...
    items: [
      {
        ...
        answer:
          "VeraDial is available now on iOS via the App Store and on Android via Google Play. Download the app to get started with a free trial and bonus credits.",
      },
      {
