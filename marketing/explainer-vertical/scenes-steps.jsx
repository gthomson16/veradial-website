...
function PhoneBezel({ children, width = 460, style = {} }) {
        ...
        return (
          <div style={{
            ...
            <div style={{
              ...
              <Eyebrow size={18} style={{ marginBottom: 20 }}>Step one</Eyebrow>
              <div style={{
              ...
              <div style={{
                display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '12px 28px',
            ...
            {/* Bottom: phone mock with real screenshot */}
            <div style={{
              flex: 1,
        ...
        return (
          <div style={{
            ...
            <div style={{
              ...
              <Eyebrow size={18} color={VD.accentViolet} style={{ marginBottom: 20 }}>Step two</Eyebrow>
              <div style={{
                fontFamily: FONT_DISPLAY,
                fontWeight: 600,
                fontSize: 84,
