...
render_shot() {
  ...
  phone_w="$(awk "BEGIN { printf \"%d\", ${CANVAS_W} * ${PHONE_SCALE} }")"
...
echo "→ Concatenating"
SILENT_MASTER="${BUILD_DIR}/veradial-preview-master-silent.mp4"
...
MASTER="${BUILD_DIR}/veradial-preview-master.mp4"
