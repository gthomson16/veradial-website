        ...
        return (
          <div style={{
            ...
            <div style={{
              ...
              <Eyebrow size={18} color={VD.accentCoral} style={{ marginBottom: 32 }}>Step three</Eyebrow>
              <div style={{
            ...
            {/* Right: phone with dialer → ai-detail */}
            <div style={{
        ...
        return (
          <div style={{
            ...
            <div style={{
              ...
              <img src="assets/google-play-badge.svg" style={{ height: 72 }}/>
              <img src="assets/app-store-badge.svg" style={{ height: 72 }}/>
            </div>
            <div style={{
              position: 'absolute',
              bottom: 180,
...
function Watermark() {
  ...
  return (
    <div style={{
      ...
      <img src="assets/veradial-icon.png" style={{ width: 40, height: 40, borderRadius: 10 }}/>
      <div style={{ fontFamily: FONT_DISPLAY, fontWeight: 600, fontSize: 22, letterSpacing: '-0.02em' }}>
        <span style={{ color: VD.textPrimary }}>Vera</span><span style={{ color: VD.accent }}>Dial</span>
      </div>
      <div style={{
        width: 1, height: 20, marginLeft: 12,
