# VeraDial Play Store Listing

Paste-ready copy for the Google Play Console main store listing. All character counts verified.
...
**Alternatives to test later in Store Listing Experiments:**
- `VeraDial: Business Phone + AI` (29 / 30) — leads with the broader generic
- `VeraDial: AI Calling for Work` (29 / 30) — different keyword angle

## Short Description

```
Get a business phone number with AI calling, SMS, voicemail & caller ID.
```
...
**Characters:** 2,920 / 4,000

## How to apply

1. Open Play Console → Grow → Store presence → Main store listing
2. Paste each field above
3. Save (changes typically apply within hours)

## Notes on choices

- **Bullet personas** — easier to scan on mobile than paragraph form
- **Named competitors kept** — captures "Google Voice alternative" / "OpenPhone alternative" search intent (real, indexed by Google Play)
- **"Never used to train AI models" kept** — verifiable from your privacy policy and a real differentiator in 2026
- **Removed "under 5 minutes" claim** — not always operationally true (number search/setup time varies)
- **No emojis** — matches your operator-focused, no-fluff brand voice
- **No fake testimonials** — pending real customer reviews
